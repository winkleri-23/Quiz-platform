    ...
    >
      <div style={{ maxWidth: 920, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: 16, marginBottom: 64 }}>
          ...
          <a href="/article/wifi-security" onClick={() => handlePick("article_wifi_security")} style={cardBase} onMouseEnter={cardHover} onMouseLeave={cardUnhover}>
            <div style={{ fontSize: 11, color: COLORS.red, letterSpacing: 3, marginBottom: 10 }}>ARTICLE_QUIZ_03</div>
            <div style={{ fontSize: 12, color: COLORS.muted, letterSpacing: 1, marginBottom: 6, textTransform: "uppercase" }}>CISSP D4</div>
            <h2 style={{ fontSize: 24, fontWeight: 700, lineHeight: 1.15, marginBottom: 12, letterSpacing: -0.5 }}>
              <span style={{ color: COLORS.red }}>Wi-Fi Security</span><br />
              for CISSP
            </h2>
            <p style={{ fontSize: 13, color: "#bbbbbb", lineHeight: 1.55, marginBottom: 14 }}>
              WEP · WPA · WPA2 · WPA3 · PSK · SAE · 802.1X. Every Wi-Fi scenario the exam will throw at you.
            </p>
            <div style={{ fontSize: 10, color: COLORS.muted, letterSpacing: 1.2, lineHeight: 1.6, marginBottom: 18 }}>
              10 QUESTIONS · ~6 MIN · INSTANT FEEDBACK
            </div>
          ...
          <a href="/article/backup-strategies" onClick={() => handlePick("article_backup_strategies")} style={cardBase} onMouseEnter={cardHover} onMouseLeave={cardUnhover}>
            <div style={{ fontSize: 11, color: COLORS.red, letterSpacing: 3, marginBottom: 10 }}>ARTICLE_QUIZ_05</div>
            <div style={{ fontSize: 12, color: COLORS.muted, letterSpacing: 1, marginBottom: 6, textTransform: "uppercase" }}>CC · CISSP D7 · Security+</div>
            <h2 style={{ fontSize: 24, fontWeight: 700, lineHeight: 1.15, marginBottom: 12, letterSpacing: -0.5 }}>
              <span style={{ color: COLORS.red }}>Backup Strategies</span><br />
              for CISSP
            </h2>
            <p style={{ fontSize: 13, color: "#bbbbbb", lineHeight: 1.55, marginBottom: 14 }}>
              Full · incremental · differential · vaulting · journaling · mirroring · 3-2-1 rule. Includes the classic incremental-vs-differential exam trap.
            </p>
            <div style={{ fontSize: 10, color: COLORS.muted, letterSpacing: 1.2, lineHeight: 1.6, marginBottom: 18 }}>
              10 QUESTIONS · ~6 MIN · INSTANT FEEDBACK
            </div>
          ...
          <a href="/article/containers-vs-vms" onClick={() => handlePick("article_containers_vs_vms")} style={cardBase} onMouseEnter={cardHover} onMouseLeave={cardUnhover}>
            <div style={{ fontSize: 11, color: COLORS.red, letterSpacing: 3, marginBottom: 10 }}>ARTICLE_QUIZ_06</div>
            <div style={{ fontSize: 12, color: COLORS.muted, letterSpacing: 1, marginBottom: 6, textTransform: "uppercase" }}>CC · CISSP D3 · Security+</div>
            <h2 style={{ fontSize: 24, fontWeight: 700, lineHeight: 1.15, marginBottom: 12, letterSpacing: -0.5 }}>
              <span style={{ color: COLORS.red }}>Containers vs VMs</span><br />
              for CISSP
            </h2>
            <p style={{ fontSize: 13, color: "#bbbbbb", lineHeight: 1.55, marginBottom: 14 }}>
              VM vs container architecture · hypervisor types · isolation vs efficiency · when to pick each. The guest OS trap included.
            </p>
            <div style={{ fontSize: 10, color: COLORS.muted, letterSpacing: 1.2, lineHeight: 1.6, marginBottom: 18 }}>
              10 QUESTIONS · ~6 MIN · INSTANT FEEDBACK
            </div>
          ...
          <a href="/article/email-authentication" onClick={() => handlePick("article_email_auth")} style={cardBase} onMouseEnter={cardHover} onMouseLeave={cardUnhover}>
            <div style={{ fontSize: 11, color: COLORS.red, letterSpacing: 3, marginBottom: 10 }}>ARTICLE_QUIZ_07</div>
            <div style={{ fontSize: 12, color: COLORS.muted, letterSpacing: 1, marginBottom: 6, textTransform: "uppercase" }}>CC · CISSP D4 · Security+</div>
            <h2 style={{ fontSize: 24, fontWeight: 700, lineHeight: 1.15, marginBottom: 12, letterSpacing: -0.5 }}>
              <span style={{ color: COLORS.red }}>SPF · DKIM · DMARC</span><br />
              Email Authentication
            </h2>
            <p style={{ fontSize: 13, color: "#bbbbbb", lineHeight: 1.55, marginBottom: 14 }}>
              Why spoofing works and what stops it. Includes a live domain-checker that generates the dig / nslookup commands for you.
            </p>
            <div style={{ fontSize: 10, color: COLORS.muted, letterSpacing: 1.2, lineHeight: 1.6, marginBottom: 18 }}>
              10 QUESTIONS · ~6 MIN · INTERACTIVE CHECKER
            </div>
            <div style={{ display: "inline-block", fontSize: 12, fontWeight: 600, letterSpacing: 1.5, color: COLORS.white, backgroundColor: COLORS.red, padding: "12px 20px" }}>
              START QUIZ →
            </div>
          ...
          <a href="/article/identity-lifecycle" onClick={() => handlePick("article_identity_lifecycle")} style={cardBase} onMouseEnter={cardHover} onMouseLeave={cardUnhover}>
            ...
            <h2 style={{ fontSize: 24, fontWeight: 700, lineHeight: 1.15, marginBottom: 12, letterSpacing: -0.5 }}>
              <span style={{ color: COLORS.red }}>Identity Lifecycle</span><br />
              Management
            </h2>
            <p style={{ fontSize: 13, color: "#bbbbbb", lineHeight: 1.55, marginBottom: 14 }}>
              Ownership, least privilege, privilege creep, reviews, and automated deprovisioning. The IAM traps every CISSP interview asks about.
            </p>
            <div style={{ fontSize: 10, color: COLORS.muted, letterSpacing: 1.2, lineHeight: 1.6, marginBottom: 18 }}>
          ...
          <a href="/article/siem" onClick={() => handlePick("article_siem")} style={cardBase} onMouseEnter={cardHover} onMouseLeave={cardUnhover}>
            <div style={{ fontSize: 11, color: COLORS.red, letterSpacing: 3, marginBottom: 10 }}>ARTICLE_QUIZ_08</div>
            <div style={{ fontSize: 12, color: COLORS.muted, letterSpacing: 1, marginBottom: 6, textTransform: "uppercase" }}>CC · CISSP · Security+</div>
            <h2 style={{ fontSize: 24, fontWeight: 700, lineHeight: 1.15, marginBottom: 12, letterSpacing: -0.5 }}>
              <span style={{ color: COLORS.red }}>SIEM</span><br />
              Fundamentals
            </h2>
            <p style={{ fontSize: 13, color: "#bbbbbb", lineHeight: 1.55, marginBottom: 14 }}>
              Correlation, false positives, tuning, and why a SIEM never replaces analysts. The SOC-interview SIEM questions everyone gets wrong.
            </p>
            <div style={{ fontSize: 10, color: COLORS.muted, letterSpacing: 1.2, lineHeight: 1.6, marginBottom: 18 }}>
              8 QUESTIONS · ~5 MIN · INSTANT FEEDBACK
            </div>
